...
export const metadata = {
  title: "Mid-Am Majors (Mock B) | midamgolfHQ",
  description: "Mock B: month cards with rows inside.",
};

export default function MidAmMajorsMockB() {
  return (
    <SiteShell>
      <div className="mx-auto w-full max-w-5xl px-5 py-8">
        <div className="mb-6">
          <div className="text-xs font-medium text-zinc-500">Mock B</div>
          <h1 className="mt-2 font-serif text-4xl font-semibold tracking-tight text-zinc-950">Mid-Am Majors</h1>
          <p className="mt-3 text-sm leading-relaxed text-zinc-600">Grouped by month. Each month is a “module card.”</p>
        </div>

        <div className="grid gap-4 lg:grid-cols-2">
          {MONTHS.map((m) => (
            <section key={m.month} className="rounded-3xl border border-zinc-200 bg-white p-6">

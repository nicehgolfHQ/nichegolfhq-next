    ...
    news: [
      {
        ...
        author: "midamgolfHQ Staff",
        content: [
          "Rob Couture and John Hunter emerged from a dramatic Saturday at Garden City Golf Club to set up a Championship Flight semifinal showdown on Sunday morning. Couture, the medalist and No. 1 seed, dispatched Joe Saladino 2&1 in the morning round, then edged Daniel Abbondandolo 2&1 in the quarterfinals to reach the final four. On the bottom half, John Hunter knocked off Matt Parziale 3&2 before grinding past Joseph Deraney 2&1. They'll face Chris DeJohn and Pat Wilson, respectively — DeJohn survived a 19-hole thriller against Kyle Downey before beating Matthew Mattare on 18 in the quarters, while Wilson edged Jordan Utley on the 20th hole and then took down Stephen Nicholas Jr 1-up.",
          "The Devereux Emmet Cup produced its own fireworks. No. 16 seed Garett Engel stunned top-seeded Dan MacDonald 3&2, while Griffin McQuilling rolled through the top half to reach the semifinals with a dominant 5&3 win over Engel. Matthew Naumec handled Trip Kuehne 3&2 and Andrew Biggadike 4&3 to set up the other semifinal against Andrew Lane, who beat Colby Anderson 5&4 and then Andrew Lane advanced 4&3. Brett Cooper also pushed through, edging Jay Crowley 1-up before falling to Jonathan Jeter 3&2. In the Eisenhower Cup, Roger Newsom and Dave Scialabba lead the top half into the semis, while Doug Clapp and Kevin Gai emerged from the bottom. The 8-player flights set their semifinal matchups: John Patterson vs Jack Downey and Steve White vs Kevin Miller in the Macdonald Cup; Connor Casey vs Jesse Bull and Billy Kreitsek Jr vs Brian Falk in the Jones Cup; Oscar Maxfield vs Richard VanderMass and Derek Rogers vs TJ Shuart in the Taft Cup. All finals are Sunday afternoon. Live scoring on the nichegolfHQ tournament hub.",
        ],
      },
      {

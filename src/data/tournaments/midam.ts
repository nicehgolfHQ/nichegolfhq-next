...
export const MIDAM_TOURNAMENTS: Tournament[] = [
...

  {
    ...
    channel: "midam",
    tournamentWebsite: "https://www.championsgolfclub.com/champions-cup",
  ...
  },
  {
    ...
    news: [
      {
        slug: "2026-travis-invitational-final-recap",
        title: "Chris DeJohn Goes Back-to-Back at the 116th Walter J. Travis Invitational",
        date: "2026-05-17",
        author: "midamgolfHQ Staff",
        content: [
      ...
      {
        slug: "2026-travis-invitational-saturday-results",
        title: "Couture and Hunter Reach Championship Semifinal; Upsets Shake the Brackets at Garden City",
        date: "2026-05-16",
        author: "midamgolfHQ Staff",
        content: [
          "Rob Couture and John Hunter both advanced through two rounds of match play on a dramatic Saturday at Garden City Golf Club, reaching opposite sides of Sunday's Championship Flight semifinal bracket. Couture, the medalist and No. 1 seed, dispatched Joe Saladino 2&1 in the morning round, then beat Daniel Abbondandolo 2&1 in the quarterfinals. On the bottom half, John Hunter knocked off Matt Parziale 3&2 before grinding past Joseph Deraney 2&1. They'll face Chris DeJohn and Pat Wilson, respectively — DeJohn survived a 19-hole thriller against Kyle Downey before beating Matthew Mattare on 18 in the quarters, while Pat Wilson beat Stephen Nicholas Jr 1-up in the morning and then dispatched Jordan Utley in the quarterfinals. Utley had earlier ousted Christian Cavaliere on the 20th hole in the Round of 16.",
          "The Devereux Emmet Cup produced its own fireworks. No. 16 seed Garett Engel stunned top-seeded Dan MacDonald 3&2, but Griffin McQuilling ended Engel's run with a dominant 5&3 win to reach the semifinals. Matthew Naumec handled Trip Kuehne 3&2 and then Andrew Biggadike 3&2 to advance from the top half. In the bottom half, Colby Anderson upset Brian Williams 5&4, while Andrew Lane beat Patrick Knott 4&3. Brett Cooper edged Jay Crowley 1-up, and Jonathan Jeter knocked off Mike Connors 3&2. The semifinalists are McQuilling vs Naumec and Lane vs Cooper. The 8-player flights set their semifinal matchups: John Patterson vs Jack Downey and Steve White vs Kevin Miller in the Macdonald Cup; Connor Casey vs Jesse Bull and Billy Kreitsek Jr vs Brian Falk in the Jones Cup; Oscar Maxfield vs Richard VanderMass and Derek Rogers vs TJ Shuart in the Taft Cup. All finals are Sunday afternoon. Live scoring on the midamgolfHQ tournament hub.",
        ],
      },
      {
        ...
        content: [
          ...
          "CHAMPIONSHIP FLIGHT (16): (1) Rob Couture (Maridoe GC) vs (16) Joe Saladino (Huntington CC) • (8) Bradford Tilley (Sleepy Hollow) vs (9) Daniel Abbondandolo (Brookville CC) • (4) Kyle Downey (Oak Hill CC) vs (13) Chris DeJohn (Arcola CC) • (5) Matthew Mattare (Saucon Valley CC) vs (12) Tanner Owen (Garden City GC) • (2) John Hunter (Carlton Woods) vs (15) Matt Parziale (Thorny Lea GC) • (7) Joseph Deraney (Tupelo CC) vs (10) Brett Williams (The Golf Club) • (3) Christian Cavaliere (Mahopac GC) vs (14) Jordan Utley (Hermitage CC) • (6) Pat Wilson (Hamilton Farm GC) vs (11) Stephen Nicholas Jr (Winged Foot)",
          "DEVEREUX EMMET CUP (16): (1) Dan MacDonald (Arcola CC) vs (16) Garett Engel (Seawane CC) • (8) Griffin McQuilling (Garden City GC) vs (9) Bryan Pendrick (Meadow Brook) • (4) Matthew Naumec (Boston) vs (13) Trip Kuehne (Vaquero GC) • (5) Andrew Biggadike (Seminole GC) vs (12) Michael Savitt (Deepdale GC) • (2) Brian Williams (Winged Foot) vs (15) Colby Anderson (Nassau CC) • (7) Andrew Lane (Garden City GC) vs (10) Patrick Knott (Merion GC) • (3) Brett Cooper (Seawane CC) vs (14) Jay Crowley (Round Hill) • (6) Mike Connors (Abacoa GC) vs (11) Jonathan Jeter (Bethpage GC)",
          "CHARLES B. MACDONALD CUP (8): (1) Nico Donaldson (Deepdale GC) vs (8) Steve White • (4) Ryan Coughlin (Westchester CC) vs (5) John Patterson (Chechessee Creek) • (2) Nick Cassini (Atlanta Athletic) vs (7) Jack Downey (Meadow Brook) • (3) Kevin Miller (Hermitage CC) vs (6) Rob Mangini (Whisper Rock)",
          "ROBERT T. JONES CUP (8): (1) Connor Casey (Somerset Hills) vs (8) Tyler McKeever (Bobby Jones GC) • (4) Jesse Bull (Golden Valley) vs (5) Tanner Murphy (Scioto CC) • (2) Jonathan Keane (Olympic GC) vs (7) Billy Kreitsek (Garden City GC) • (3) Shane Heise (Carlton Woods) vs (6) Brian Falk (Garden City GC)",
          "WILLIAM H. TAFT CUP (8): (1) Ben Greve (Olympic Hills) vs (8) Oscar Maxfield (The Country Club) • (4) Richard VanderMass (The Creek) vs (5) Steven Tarulli (Hempstead GC) • (2) Brandon Dalinka (Baltusrol) vs (7) Derek Rogers (Meadow Brook) • (3) West Streib (Deepdale GC) vs (6) TJ Shuart (Fort Lauderdale CC)",
          "DWIGHT D. EISENHOWER CUP (16): (1) Roger Newsom vs (16) Tom Fox • (8) Tony Hejna vs (9) Scott Mackesy • (4) Merrick McQuilling vs (13) James Romaniello • (5) Dave Scialabba vs (12) Walker Taylor • (2) Ryan Howison vs (15) David Boccia • (7) Doug Clapp vs (10) Daniel Russo • (3) Kevin Gai vs (14) Jack Eisenbeis • (6) Mark Thompson vs (11) Jim Graham",
        ],
      },
      {
        ...
        date: "2026-05-15",
        author: "midamgolfHQ Staff",
        summary: "Chris DeJohn returns to defend his Walter J. Travis title and chase a third Garden City crown at one of the most prestigious match-play events on the mid-am calendar. A look at the field, the format, and the names to watch.",
        content: [
    ...
    pastResults: [
      { year: 2026, champion: "Chris DeJohn" },
    ...
    news: [
      {
        ...
        content: [
          ...
          "Christopher Wheeler fired the low round of the day, a 3-under 69, to climb into solo fourth at 4-over 220. Johnny Spellerberg finished fifth at 5-over 221, while Tyler Thomas and Kendrick Vinar shared sixth at 6-over 222. Harvey, the two-time Huddleston Cup champion who won in 2023 and 2024, closed with a 76 to finish T11 at 9-over. Live scoring and full results are available on the [midamgolfHQ tournament hub](/midamgolfhq/the-huddleston-cup).",
        ],
        photos: [
          "/images/tournaments/huddleston-cup-2026-massa-trophy.jpeg",
        ],
      },
      {
        ...
        date: "2026-05-29",
        author: "midamgolfHQ Staff",
        summary: "Defending champion Bobby Massa posted a 1-under 71 to take a three-shot lead at 4-under 140 into the final round of the Huddleston Cup at Maridoe.",
        content: [
          "Defending champion Bobby Massa posted a steady 1-under 71 Friday to surge into the solo lead at 4-under 140 heading into the final round of The Huddleston Cup at Maridoe Golf Club in Carrollton, Texas. While first-round leader Zachary Vandolah stumbled to a 3-over 75, Massa's consistency moved him three clear of the field. Former U.S. Mid-Amateur champion Matt Parziale made the biggest move of the day, firing a 2-under 70 to climb from T13 into a tie for second alongside Vandolah at 1-under 143.",
          "Ryan Burgess holds fourth at 1-over 145, with Charlie Holland alone in fifth at 2-over 146. First-round co-runner-up Zach Atkinson had a tough day with a 79, falling into a tie for ninth. Two-time U.S. Mid-Amateur champion Scott Harvey sits T11 at 5-over after a second-round 77. Massa will look to defend his title when the final round tees off Saturday at Maridoe. Live scoring and full coverage are available on the [midamgolfHQ tournament hub](/midamgolfhq/the-huddleston-cup).",
        ],
      },
      {
    ...
    news: [
      ...
      },
      {
        ...
        content: [
          ...
          "The match play bracket is set for Saturday morning at the National Golf Links. Top-seeded Hagestad opens against 16-seed Andy Schonbaum at 9:56 AM, while Nick Cassini faces Scott Turner and Will Davenport takes on Steve White. Other first-round matchups include Johnny DelPrete vs. Sean Barrett, Jeronimo Esteve vs. Matt Parziale in a marquee 2-vs-15 clash, John Hahn vs. Hal Dove, Bobby Leopold vs. Brad Richards, and Michael Cress vs. Ryan Abbate. Second-round matches begin at 3:00 PM. midamgolfHQ will be tracking the action all weekend from Southampton.",
        ],
      },
      {
    ...
    news: [
      {
        ...
        content: [
          "Andrew Price of Conway Farms closed with a 1-under 69 to win the [George C. Thomas Invitational at Los Angeles Country Club](/midamgolfhq/george-c-thomas-invitational), finishing at 3-over 214 for the week. The 2024 Crump Cup champion looked like he might let it slip after a bogey on 16, but he holed out for birdie from a bunker left of 17 to move one ahead heading to the final hole. Cavaliere of Hudson National made a closing birdie on 18 to create drama, but Price retained his one-shot lead by drilling a six-footer for par to seal the victory. Cavaliere also fired a final-round 69 to finish solo second at 4-over. Cavaliere, who runs the popular golf brand Tremont, has been one of the most consistent mid-am competitors on the circuit this season. Charlie Holland of Lakewood Country Club matched them with a 69 of his own to claim third at 6-over.",
    ...
    news: [
      ...
      },
      {
        ...
        content: [
          ...
          "Defending champions Nick Fiore and Brian Joseph are back after posting an 11-under total at Canterbury last year, highlighted by a closing 67. They'll face a deep field headlined by Bobby Wyatt, the 2025 Crump Cup champion at Pine Valley, paired with Vince Cave. Scott Turner, a three-time Palm Beach County Amateur champion and 2025 Gasparilla champion, teams with Will Davenport, who lost the 2024 George C. Thomas Invitational in a playoff and finished T5 at this year's edition. Andy Latowski partners with John Brennan, while Blanton Farmer, a Dennis Ewing Cup winner and U.S. Amateur Four-Ball qualifier, plays alongside Brandon Ramsuer.",
          "The alternate shot round will separate the field, as team chemistry and course management become critical. Keep an eye on Jackson Beindorf, an Auburn alum who made match play at the 2009 U.S. Amateur, teaming with Lowery Thomas, and Steven Paramore paired with Gabe Reynolds. midamgolfHQ will be tracking the action all week from Canterbury.",
        ],
      },
    ],
    pastResults: [
    ...
    news: [
      {
        ...
        author: "midamgolfHQ Staff",
        summary:
          "Garrett Rank closes with a 69 to overtake 54-hole leader Evan Nachtigall and win his fourth Canadian Men's Mid-Amateur Championship at 18-under 270, joining Stu Hamilton as a four-time winner, trailing only seven-time champion Graham Cooke.",
        content: [
          "Garrett Rank completed a final-round comeback at Brantford Golf & Country Club, closing with a 3-under 69 to overtake 54-hole leader Evan Nachtigall and claim his fourth Canadian Men's Mid-Amateur Championship at 18-under 270. Rank, who won three straight from 2014 to 2016, joins Stu Hamilton as a four-time winner, trailing only seven-time champion Graham Cooke in the championship's history. Nachtigall, who held the lead wire-to-wire through 54 holes, stumbled to a 72 in the final round to finish one back at 17-under 271. Cam Burke held steady in solo third at 15-under 273 after a closing 70, while Eric Flockhart fired the low round of the day at 65 to vault ten spots into fourth at 12-under 276. Live scoring and full tournament coverage can be found on the [Canadian Men's Mid-Amateur tournament hub here](/midamgolfhq/canadian-mens-mid-amateur).",
...

  {
    ...
    news: [
      ...
      },
      {
        ...
        author: "midamgolfHQ Staff",
        summary:
          "Defending champion Kim-Schaad beats former champion Dinh 3 and 2, co-medalist Doran routs Freeman 7 and 6, and former champion Greenlief stuns co-medalist Jamieson as match play opens at Montclair Golf Club.",
        content: [
          "Defending champion Ina Kim-Schaad dispatched former champion Kimberly Dinh 3 and 2 to open match play at the 39th U.S. Women's Mid-Amateur Championship at Montclair Golf Club, advancing to a Round of 32 meeting with Brooke Tyree. Co-medalist Emilia Doran posted the most dominant win of the day, routing Ashley Freeman 7 and 6, while France's Justine Fournand cruised past Madison Isaacson 7 and 5. The day's biggest upset came when former champion Lauren Greenlief, the 62nd seed, knocked off co-medalist and 3-seed Lucy Jamieson 1 up, while former champion Julia Potter-Bobb upset 9th-seeded Shannon Fish-Martin 1 up and 2025 runner-up Hanley Long rolled past Annick Haczkiewicz 6 and 4. Live scoring and full tournament coverage can be found on the [U.S. Women's Mid-Amateur tournament hub here](/midamgolfhq/usga-womens-mid-am).",
          "The Round of 32 is set for tomorrow morning with several marquee matchups. Kim-Schaad (4) faces Brooke Tyree at 7:06 a.m., co-medalist Doran (2) draws Victoria Jackson (31) at 7:42 a.m., Talia Campbell (5) meets Kirsty Hodgkins-Redner of Australia at 7:24 a.m., and championship-low-round shooter Catherine McEvoy (6) takes on Jennifer Peng at 8:36 a.m. Three matches needed extra holes to decide, with Hodgkins-Redner prevailing on the 19th, Elizabeth Choi upsetting Maria Ouimet on the 20th, and Krissy Carman knocking off 11th-seeded Ali Schrock on the 19th. midamgolfHQ will be tracking the action through the final on Thursday from West Orange.",
        ],
      },
      {
  ...
  },
  {
    ...
    liveStatus: "completed",
    month: 9,
    dates2026: "September 14-16, 2026",
    ...
    news: [
      {
        ...
        content: [
          "Ryan Terry of Brentwood, Tenn., closed with a 4-under 67, the low round of the day, to win the Mid-Amateur division at the Trans-Miss Mid-Amateur Championship, finishing 10-under 203 at Lakewood Country Club for a five-shot victory. Terry trailed 36-hole leader Cory Chavez by one entering the final round, but a closing 73 dropped Chavez to runner-up at 5-under 208. Alex Resurreccion finished third at even-par 213. Live scoring and full tournament coverage can be found on the [Trans-Miss Mid-Amateur Championship tournament hub here](/midamgolfhq/trans-miss-mid-master-championship).",
    ...
    pastResults: [
      { year: 2026, champion: "Ryan Terry (Mid-Am) / Pat Grady (Mid-Master)" },
...

  {
    ...
    endDate: "2026-10-01",
    course: "The Lido at Sand Valley",
    location: "Nekoosa, WI",
    coursePar: 71,
    courseYardage: 7219,
    courseRating: 73.8,
    ...
    news: [
      {
        ...
        author: "midamgolfHQ Staff",
        summary:
          "A record 6,124 entries produced a 264-player field for the first USGA championship at The Lido, with seven past champions and a deep list of contenders headed to Sand Valley.",
        content: [
          "The 45th U.S. Mid-Amateur Championship tees off Saturday at Sand Valley Resort in Nekoosa, Wis., with a record 6,124 entries whittled down to a 264-player field for the first USGA championship hosted at The Lido. Two rounds of stroke play, one each on The Lido (par 71, 7,219 yards) and the Sand Valley Course (par 71, 7,122 yards), will trim the field to the low 64 for match play beginning Monday. From there it's single elimination through Thursday's 36-hole final, with the winner earning an exemption into the 2027 U.S. Open at Pebble Beach and a likely invitation to the 2027 Masters. Live scoring and full tournament coverage can be found on the [U.S. Mid-Amateur Championship tournament hub here](/midamgolfhq/usga-mens-mid-am).",
          "Stewart Hagestad of Newport Beach, Calif., arrives with serious momentum after capturing the Crump Cup Championship Flight at Pine Valley last week. The 35-year-old is chasing a record-tying fourth U.S. Mid-Amateur title to match Nathan Smith (2003, 2009, 2010, 2012), having won in 2016, 2021, and 2023 across a career that includes six Walker Cup appearances and a ranking inside the top 30 of the World Amateur Golf Ranking. Defending champion Brandon Holtz of Bloomington, Ill., a former Illinois State basketball player, returns after his breakthrough win at Troon Country Club last fall, where he drove the par-4 34th green and drained an eight-foot eagle putt to close out Jeg Coughlin III of Dublin, Ohio, 3 and 2 in the 36-hole final. Coughlin, the son and grandson of legendary drag racers Jeg Jr. and Jeg Sr., is back looking to go one step further.",
          "Seven past champions are in the field, combining for nine titles, including Kevin O'Connell (2018), Matt Parziale (2017), Sammy Schmitz (2015), Lukas Michel of Australia (2019), and Matthew McClean of Northern Ireland (2022). Among the contenders who have been playing well this season, Christian Cavaliere of Katonah, N.Y., medaled at the U.S. Amateur qualifier with a 65 at Brooklawn and advanced to the Round of 16 at Merion in August. Connor Doyal of Charleston, S.C., won the South Carolina Mid-Amateur and the Terra Cotta Invitational this year after reaching the quarterfinals in last year's championship, while Parker Edens of Brookings, S.D., the head men's golf coach at South Dakota State, is making his third straight appearance after advancing to the Round of 16 in 2024. Haymes Snedeker of Point Clear, Ala., earned his exemption as low amateur at the U.S. Senior Open at Scioto, and Garrett Rank of Canada enters as the reigning Canadian Mid-Amateur champion fresh off a Crump Cup 2nd Flight win last week.",
          "The field stretches across more than a dozen countries, with exempt players from Guatemala, the United Arab Emirates, Argentina, Bolivia, the Dominican Republic, France, and Australia joining qualifiers from Canada, England, Ireland, Japan, Mexico, Belgium, and Ecuador. Brett Patterson of Oxford, Miss., an accounting professor at Ole Miss, enters on a tear after winning the Mississippi Amateur by 11 strokes and capturing back-to-back Mississippi Mid-Amateur titles in a season that adds to his run to the 2023 U.S. Mid-Amateur semifinals. Local qualifier Adam Miller of Nekoosa, Wis., will tee it up in front of a home crowd. midamgolfHQ will be tracking the action all week from Sand Valley.",
        ],
      },
    ],
    pastResults: [

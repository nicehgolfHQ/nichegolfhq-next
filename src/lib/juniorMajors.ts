    ...
    news: [
      {
        ...
        content: [
          ...
          "Founded in 2016 by two-time major champion and South Carolina native Dustin Johnson, the tournament has grown into one of the top co-ed junior events in the country, drawing roughly 90 players to TPC Myrtle Beach. Alumni include PGA Tour winners Akshay Bhatia and Nick Dunlap.",
        ],
      },
    ],
  },
    ...
    news: [
      {
        ...
        content: [
          ...
          "The Junior Invitational at Sage Valley remains one of the most selective events on the junior calendar, with an invitation-only field of 36 boys and 24 girls competing over 72 holes at Sage Valley Golf Club in Graniteville, South Carolina. Past champions on the boys side include Scottie Scheffler, Joaquin Niemann, and Akshay Bhatia.",
        ],
      },
    ],
  },
    ...
    news: [
      {
        ...
        content: [
          "Vidhi Lakhawala closed the 2026 Nelly Invitational presented by Chevron with rounds of 69-75-71 for a 1-under 215 total, winning by one shot at The Concession Golf Club in Bradenton, Florida. Zoe Cusack and Grace Carter tied for second at even-par 216, with 2025 champion Shauna Liu and Amelie Zalsman tied for fourth at 1-over 217.",
          ...
          "Now in its third year, the Nelly Invitational was launched by LPGA star Nelly Korda at The Concession Golf Club, named for Jack Nicklaus's famous 'concession' putt to Tony Jacklin at the 1969 Ryder Cup. Chevron joined as presenting sponsor in 2025, and the champion earns a sponsor exemption into the Chevron Championship, an LPGA major.",
        ],
      },
    ],
  },
    ...
    news: [
      {
        ...
        content: [
          ...
          "Huebner set the pace with opening rounds of 65-65 to build a comfortable cushion, then played the final round steady enough to hold off a hard-charging field at Sedgefield.",
        ],
      },
    ],
  },

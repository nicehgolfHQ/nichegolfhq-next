...
export const FEEDS: FeedConfig[] = [
  {
    ...
    name: "midamgolfHQ",
    slug: "midamgolfhq",
    tagline: "Mid-amateur golf coverage — schedules, event hubs, results, and The Steam Room newsletter.",
  ...
  },
  {
    ...
    name: "seniorgolfHQ",
    slug: "seniorgolfhq",
    tagline: "Senior amateur golf coverage — schedules, event hubs, results, and newsletters.",
  ...
  },
  {
    ...
    name: "juniorgolfHQ",
    slug: "juniorgolfhq",
    tagline: "Junior golf coverage — major schedules, event hubs, results, and newsletters.",
